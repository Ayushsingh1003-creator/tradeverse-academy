 ...
 *
 * Deliberately duplicated (not imported) from the anatomy-of-a-candle lesson's
 * geometry.ts — each lesson folder in src/components/lesson stays self-contained.
 */
