  ...
  user: makeModel(
    {
      ...
      onboardingAssessmentCompletedAt: s.users.onboardingAssessmentCompletedAt,
      traderPersona: s.users.traderPersona,
      assessmentKScore: s.users.assessmentKScore,
      assessmentDScore: s.users.assessmentDScore,
      assessmentAnswers: s.users.assessmentAnswers,
      assessmentAcceleratedPace: s.users.assessmentAcceleratedPace,
    },
    s.users,
  ),
